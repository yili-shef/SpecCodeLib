program alignpc
  ...
  complex(sp), allocatable, dimension(:,:,:) :: p11,p22,p33,p
  ...
  if (iargc() .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./align-pc.x nx filelist prefix'
  ...
  open(28, file = 'align-pc-'//trim(flnm)//'.dat')
  ...
  deallocate(kx,ky,kz,b11,b12,b13,b21,b22,b23,b31,b32,b33,p11,p22,p33,p)
  
  call destroyplan3d

  write(*,*) 'align-pc.x done.'
