program align3drmt
  ...
  if (ll .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./align-3drmt.x nx filelist ndel'
  ...
  str='-'//str(1:len_trim(str))//'dx-rmt-'//fnm(1:len_trim(fnm))//'.dat'
  ...
  open(20,file=fnm(1:len_trim(fnm)))
    ...
    do while ( .not. eof(20)) 
      ...
      ! r11 is the negative component am Note hpi has been converted to hmi
