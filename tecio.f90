MODULE mTecIOInterface
  INTERFACE 

    INTEGER*4 FUNCTION tecini (Title, Variables, FName, ScratchDir, &
                               Debug, VIsDouble)
    ...
    INTEGER*4 FUNCTION teczne (ZoneTitle, IMx, JMx, KMx, ZFormat, DupList)
    ...
    INTEGER*4 FUNCTION tecdat (N, FieldData, IsDouble)
    ...
    INTEGER*4 FUNCTION teclab (S)
      !MS$ATTRIBUTES STDCALL :: teclab
      !MS$ATTRIBUTES REFERENCE :: S
      CHARACTER*(*) S
    END FUNCTION teclab
 
    INTEGER*4 FUNCTION tecusr (S)
    ...
    INTEGER*4 FUNCTION tecgeo (XPos, YPos, ZPos, PosCoordMode, AttachToZone, &
                               Zone, Color, FillColor, IsFilled, GeomType,   &
                               LinePattern, PatternLength, LineThickness,    &
                               NumEllipsePts, ArrowheadStyle,                &
                               ArrowheadAttachment, ArrowheadSize,           &
                               ArrowheadAngle, Scope, NumSegments, NumSegPts,&
                               XGeomData, YGeomData, ZGeomData, mfc)
    ...
    INTEGER*4 FUNCTION tectxt (XPos, YPos, PosCoordMode, AttachToZone,   &
                               Zone, BFont, FontHeightUnits, FontHeight, &
                               BoxType, BoxMargin, BoxLineThickness,     &
                               BoxColor, BoxFillColor, Angle, Anchor,    &
                               LineSpacing, TextColor, Scope, Text, mfc) &
    ...
    INTEGER*4 FUNCTION tecfil (F)
      !MS$ATTRIBUTES STDCALL :: tecfil
      !MS$ATTRIBUTES REFERENCE :: F
      INTEGER*4  F
    END FUNCTION tecfil
 
    INTEGER*4 FUNCTION tecini100 (Title, Variables, FName, ScratchDir, &
                                  Debug, VIsDouble)
    ...
    INTEGER FUNCTION teczne100(ZoneTitle, ZoneType, IMxOrNumPts,     &
                               JMxOrNumElements, KMx, ICellMax,      &
                               JCellMax, KCellMax, IsBlock,          &
                               NumFaceConnections, FaceNeighborMode, &
                               ValueLocation, ShareVarFromZone,      &
    ...
    INTEGER*4 FUNCTION tecdat100 (N, FieldData, IsDouble)
    ...
    INTEGER*4 FUNCTION teclab100 (S)
    ...
    INTEGER*4 FUNCTION tecgeo100 (XPos, YPos, ZPos, PosCoordMode,       &
                                  AttachToZone, Zone, Color, FillColor, &
                                  IsFilled, GeomType, LinePattern,      &
                                  PatternLength, LineThickness,         &
                                  NumEllipsePts, ArrowheadStyle,        &
                                  ArrowheadAttachment, ArrowheadSize,   &
                                  ArrowheadAngle, Scope, Clipping,      &
                                  NumSegments, NumSegPts, XGeomData,    &
    ...
    INTEGER*4 FUNCTION tectxt100 (XOrThetaPos, YOrRPos, ZOrUnusedPos,   &
                                  PosCoordMode, AttachToZone, Zone,     &
                                  Font, FontHeightUnits, FontHeight,    &
                                  BoxType, BoxMargin, BoxLineThickness, &
                                  BoxColor, BoxFillColor, Angle, Anchor,&
                                  LineSpacing, TextColor, Scope,        &
                                  Clipping, Text, mfc)
    ...
    INTEGER FUNCTION tecauxstr100 (Name, Value)
    ...
    INTEGER FUNCTION teczauxstr100 (Name, Value)
