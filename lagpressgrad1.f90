program lagpg
  ...
  real(sp) :: meanpX2, meanpY2, meanpZ2, meanafn
  real(sp) :: afntmp, pkpk, meanpkpk, dpdX, dpdY, dpdZ, trc, meaneulerpx
  
  if (iargc() .ne. 3) then
          write(*,*)
          write(*,*) ' >>>>>> Wrong number of arguments <<<<<<'
          write(*,*) 
          write(*,*) ' Usage: ./lagpressgrad1.x nx filelist prefix'
  ...
  write(27,*) 'file pkpk pX2 pY2 pZ2 AA sqrt(trc) '
