program staligntovtk
  ...
  real(sp), dimension(npnt, npnt, npnt) :: pdf

  integer :: ii, jj, kk
  character(80) :: fpath
  integer :: vtkopenfile, vtk_rg_header, vtkscalar, vtkclosefile

  open(17, file='jpalign-3d-16dx-st-helimtlm.dat')
  read(17,*)
  do kk = 1, npnt
  do jj = 1, npnt
  do ii = 1, npnt
    read(17,'(15E15.5)') xco(ii), yco(jj), zco(kk), pdf(ii,jj,kk)
  end do
  end do
  end do
  close(17)
  ...
  fpath = "jpalign-3dst-16dx-helimtlm.vtk0"
