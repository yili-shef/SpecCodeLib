...
!========  parameter for velocity field   =========
  ...
  !real(8), parameter :: eta = Ldom/(nt*phi)
...
!....... definitions in fftw3.f ......................................
  ...
  complex(8), allocatable, dimension(:,:,:) :: vx04 ,vy04 ,vz04
  complex(8), allocatable, dimension(:,:,:) :: vx02 ,vy02 ,vz02
  ...
  integer(8) FTvx04,FTvy04,FTvz04,IFTvx04,IFTvy04,IFTvz04
  integer(8) FTvx02,FTvy02,FTvz02,IFTvx02,IFTvy02,IFTvz02
  ...
  allocate(vx04(nt/256 + 1 ,nt/128 ,nt/128),vy04(nt/128 + 1,nt/128,nt/128),vz04(nt/128 + 1 ,nt/128 ,nt/128) )
  ...
  nnr = nt/128
  print *,nnr
  call dfftw_plan_dft_c2r_3d(IFTvx04,nnr,nnr,nnr,vx04,vx04,FFTW_MEASURE)
  call dfftw_plan_dft_c2r_3d(IFTvy04,nnr,nnr,nnr,vy04,vy04,FFTW_MEASURE)
  call dfftw_plan_dft_c2r_3d(IFTvz04,nnr,nnr,nnr,vz04,vz04,FFTW_MEASURE)
  
  call dfftw_plan_dft_r2c_3d(FTvx04,nnr,nnr,nnr,vx04,vx04,FFTW_MEASURE)
  call dfftw_plan_dft_r2c_3d(FTvy04,nnr,nnr,nnr,vy04,vy04,FFTW_MEASURE)
  call dfftw_plan_dft_r2c_3d(FTvz04,nnr,nnr,nnr,vz04,vz04,FFTW_MEASURE)
...
!  close(unit=21)
  ...
  call apply_MTLM(vx04,vy04,vz04,nt/128 + 2,                         &
                  IFTvx04,IFTvy04,IFTvz04,FTvx04,FTvy04,FTvz04)
