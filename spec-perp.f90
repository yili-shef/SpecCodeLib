program specperp
  ...
  if (ii .ne. 2) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./spec-perp.x nx filelist'
      ...
      do kk=1,lz
        ...
        do jj=1,ly
          ...
          do ii=1,lx1
            ...
            ll=floor(sqrt(kxii*kxii+kyjj*kyjj)+.5)
  ...
  open(24,file='spec-perp-'//str(1:len_trim(str))//'.dat')
  do ii=1,lx
    write(24,*) ii,ek(ii)/nfile
  end do
  close(24)

  deallocate(kx,ky,kz,ux,uy,uz,ek )

  write(*,*) 'spec-perp.x finished'
end program specperp
