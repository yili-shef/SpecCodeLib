...
!....... definitions in fftw3.f ......................................
  ...
  integer, parameter :: nunit = 8
  complex(8), dimension(nunit*32 + 1,nunit*32 ,nunit*32 ) :: vx256,vy256,vz256 
  complex(8), dimension(nunit*16 + 1,nunit*16 ,nunit*16 ) :: vx128,vy128,vz128 
  complex(8), dimension(nunit*8  + 1,nunit*8  ,nunit*8  ) :: vx64 ,vy64 ,vz64
  complex(8), dimension(nunit*4  + 1,nunit*4  ,nunit*4  ) :: vx32 ,vy32 ,vz32
  complex(8), dimension(nunit*2  + 1,nunit*2  ,nunit*2  ) :: vx16 ,vy16 ,vz16
  complex(8), dimension(nunit    + 1,nunit    ,nunit    ) :: vx08 ,vy08 ,vz08
...
!  close(unit=21)
  ...
  call apply_MTLM(vx08,vy08,vz08,nunit + 2,                         &
                  IFTvx08,IFTvy08,IFTvz08,FTvx08,FTvy08,FTvz08)
  
  call apply_MTLM(vx16,vy16,vz16,nunit*2 + 2,                         &
                  IFTvx16,IFTvy16,IFTvz16,FTvx16,FTvy16,FTvz16)
  
  call apply_MTLM(vx32,vy32,vz32,nunit*4 + 2,                          &
                  IFTvx32,IFTvy32,IFTvz32,FTvx32,FTvy32,FTvz32)
  
  call apply_MTLM(vx64,vy64,vz64,nunit*8 + 2,                          &
                  IFTvx64,IFTvy64,IFTvz64,FTvx64,FTvy64,FTvz64)
  
  call apply_MTLM(vx128,vy128,vz128,nunit*16 + 2,IFTvx128,IFTvy128,    &
                  IFTvz128,FTvx128,FTvy128,FTvz128)
  
  call apply_MTLM(vx256,vy256,vz256,nunit*32 + 2,IFTvx256,IFTvy256,    &
