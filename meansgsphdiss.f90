program meansgsphdiss
  ...
  write(*,*) 
  write(*,'(''>>> Mean sgs helicity dissipation by positive helical modes<<< '')')
  write(*,*)
  ...
  if (ll .ne. 4) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./meansgsphdiss.x nx filelist ndel numfilter'
          write(*,*) '        nx: resolution'
  ...
  str1 = 'phdiss-'//str1(1:len_trim(str1))//'.dat'
