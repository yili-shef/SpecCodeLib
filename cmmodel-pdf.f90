program rcmpdf
  ...
  integer, parameter :: npnt = 400000, three = 3
  ...
  if (ll .ne. 4) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./cmmodel-pdf.x nfiles nstart nreal ifirst'
  ...
  str = 'mean-'//strreal(1:len_trim(strreal))//'reals.dat'
  open(15, file = str(1:len_trim(str)) )
  read(15,*)

  str = 'rms-'//strreal(1:len_trim(strreal))//'reals.dat'
  open(16, file = str(1:len_trim(str)) )
  read(16,*)

  str = 'pdfcmaii-'//strreal(1:len_trim(strreal))//'reals.dat'
  open(20, file = str(1:len_trim(str)) )

  str = 'pdfcmaij-'//strreal(1:len_trim(strreal))//'reals.dat'
