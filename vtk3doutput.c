...
int vtkopenfile_(char *outfn, long int fnlen)
{
    *(outfn+fnlen-1) = '\0';
    fs = fopen(outfn, "wb");
...
int vtk_sp_header_(int *nbytes, int *nx, int *ny, int *nz, 
        void *ox, void *oy, void *oz, void *spx, void *spy, void*spz)
{
...
int vtk_rg_header_(void *xco, void *yco, void *zco, int *nbytes, int *nx, 
        int *ny, int *nz)
{
