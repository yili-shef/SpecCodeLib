program rcmmean
  ...
  if (ll .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./rcm-mean-s(d)p.x filelist nreal ifirst'
  ...
  str = 'mean-'//strro(1:len_trim(strro))//'.dat'
  open(15, file = str(1:len_trim(str)) )
  write(15, '(''#meanaiiall meanaiiperp meanaiipara meana12 meana13 meana21 meana23 meana31 meana32'')')

  str = 'rms-'//strro(1:len_trim(strro))//'.dat'
  open(16, file = str(1:len_trim(str)) )
  write(16, '(''#rmsaiiall rmsaiiperp rmsaiipara rmsa12 rmsa13 rmsa21 rmsa23 rmsa31 rmsa32'')')

  str = 'skew-'//strro(1:len_trim(strro))//'.dat'
  open(17, file = str(1:len_trim(str)) )
  write(17, '(''#skewaiiall skewaiiperp skewaiipara skewa12 skewa13 skewa21 skewa23 skewa31 skewa32'')')

  str = 'flat-'//strro(1:len_trim(strro))//'.dat'
  open(18, file = str(1:len_trim(str)) )
  write(18, '(''#flataiiall flataiiperp flataiipara flata12 flata13 flata21 flata23 flata31 flata32'')')
  ...
  do while ( .not. eof(20))
    ...
    write(15, '(15E13.4)') meanaiiall, meanaiiperp, meanaiipara, meana12, meana13, meana21, &
                           meana23, meana31, meana32 
 
    write(16, '(15E13.4)') rmsaiiall, rmsaiiperp, rmsaiipara, rmsa12, rmsa13, rmsa21, &
                           rmsa23, rmsa31, rmsa32 
 
    write(17, '(15E13.4)') skewaiiall, skewaiiperp, skewaiipara, skewa12, skewa13, skewa21, &
                           skewa23, skewa31, skewa32 
 
    write(18, '(15E13.4)') flataiiall, flataiiperp, flataiipara, flata12, flata13, flata21, &
