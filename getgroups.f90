program getgroups
    ...
    integer, parameter :: radius = 3, ngroups = (nx / nskip)**3
    integer, parameter :: npntgrp = (2*radius + 1)**3
    ...
    do ll = 1, ngroups
        ...
        do iiloc = -1, 1
            ...
            do ii = 1, nx
                    ...
                    if ( mm .gt. 1 .and. mm .le. radius ) then
    ...
    fdata = 'xyz'//strgrp(1:len_trim(strgrp))//'grps'//strpnt(1:len_trim(strpnt))//'pnts.dat'
