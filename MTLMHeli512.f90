...
complex(8), allocatable, dimension(:,:,:) :: vx,vy,vz
...
!complex(8), allocatable, dimension(nt/4 + 1 ,nt/2 ,nt/2 ) :: vx256,vy256,vz256 
!complex(8), allocatable, dimension(nt/8 + 1 ,nt/4 ,nt/4 ) :: vx128,vy128,vz128 
!complex(8), allocatable, dimension(nt/16 + 1 ,nt/8 ,nt/8 ) :: vx64 ,vy64 ,vz64
!complex(8), allocatable, dimension(nt/32 + 1 ,nt/16 ,nt/16 ) :: vx32 ,vy32 ,vz32
!complex(8), allocatable, dimension(nt/64 + 1, nt/32,nt/32) :: vx16 ,vy16 ,vz16
!complex(8), allocatable, dimension(nt/128 + 1,nt/64,nt/64) :: vx08 ,vy08 ,vz08
...
allocate(vx(nt/2 + 1,nt,nt), vy(nt/2 + 1,nt,nt),vz(nt/2 + 1,nt,nt) )
allocate(vx256(nt/4 + 1 ,nt/2 ,nt/2 ))
allocate(vy256(nt/4 + 1 ,nt/2 ,nt/2 ))
allocate(vz256(nt/4 + 1 ,nt/2 ,nt/2 ))
allocate(vx128(nt/8 + 1 ,nt/4 ,nt/4 ))
allocate(vy128(nt/8 + 1 ,nt/4 ,nt/4 ))
allocate(vz128(nt/8 + 1 ,nt/4 ,nt/4 ))
allocate(vx64(nt/16 + 1 ,nt/8 ,nt/8 ))
allocate(vy64(nt/16 + 1 ,nt/8 ,nt/8 ))
allocate(vz64(nt/16 + 1 ,nt/8 ,nt/8 ))
allocate(vx32(nt/32 + 1 ,nt/16 ,nt/16 ))
allocate(vy32(nt/32 + 1 ,nt/16 ,nt/16 ))
allocate(vz32(nt/32 + 1 ,nt/16 ,nt/16 ))
allocate(vx16(nt/64 + 1 ,nt/32 ,nt/32 ))
allocate(vy16(nt/64 + 1 ,nt/32 ,nt/32 ))
allocate(vz16(nt/64 + 1 ,nt/32 ,nt/32 ))
allocate(vx08(nt/128 + 1 ,nt/64 ,nt/64 ))
allocate(vy08(nt/128 + 1 ,nt/64 ,nt/64 ))
allocate(vz08(nt/128 + 1 ,nt/64 ,nt/64 ))
...
output = .false.
    ...
    deallocate(vx,vy,vz,vx256,vy256,vz256,vx128,vy128,vz128,vx64,vy64,vz64)
    deallocate(vx32,vy32,vz32,vx16,vy16,vz16,vx08,vy08,vz08)
