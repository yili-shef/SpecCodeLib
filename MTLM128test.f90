...
complex(8), dimension(nt/4 + 1 ,nt/2 ,nt/2 ) :: vx64 ,vy64 ,vz64 
complex(8), dimension(nt/8 + 1 ,nt/4 ,nt/4 ) :: vx32 ,vy32 ,vz32
complex(8), dimension(nt/16 + 1,nt/8 ,nt/8 ) :: vx16 ,vy16 ,vz16
complex(8), dimension(nt/32 + 1,nt/16,nt/16) :: vx08 ,vy08 ,vz08

!...for reduced scalar field
complex(8), dimension(nt/4 + 1 ,nt/2 ,nt/2 ) :: theta64 
complex(8), dimension(nt/8 + 1 ,nt/4 ,nt/4 ) :: theta32 
complex(8), dimension(nt/16 + 1,nt/8 ,nt/8 ) :: theta16 
complex(8), dimension(nt/32 + 1,nt/16,nt/16) :: theta08 
...
epsilon = epsl
!open(unit=21, file='random_vxvyvz0128.bin', form='unformatted')
!write(21) vx
!write(21) vy
!write(21) vz
!close(unit=21)
...
!call apply_MTLM(vx08,vy08,vz08,theta08,nt/16 + 2,                         &
!                IFTvx08,IFTvy08,IFTvz08,IFTth08,FTvx08,FTvy08,FTvz08,FTth08)

!call apply_MTLM(vx16,vy16,vz16,theta16,nt/8 + 2,                         &
!                IFTvx16,IFTvy16,IFTvz16,IFTth16,FTvx16,FTvy16,FTvz16,FTth16)

!call apply_MTLM(vx32,vy32,vz32,theta32,nt/4 + 2,                          &
!                IFTvx32,IFTvy32,IFTvz32,IFTth32,FTvx32,FTvy32,FTvz32,FTth32)

call apply_MTLM(vx64,vy64,vz64,theta64,nt/2 + 2,                          &
