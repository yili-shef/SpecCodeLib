program align3drtnl
  ...
  if (ll .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./align-3drt-nl-cnd.x nx filelist ndel'
  ...
  str='-'//str(1:len_trim(str))//'dx-rtnl-'//fnm(1:len_trim(fnm))//'.dat'
  ...
  open(20,file=fnm(1:len_trim(fnm)))
    ...
    do while ( .not. eof(20) ) 
      ...
      do jj = 1, ly
      do ii = 1, lx1
        t22(ii,jj,kk) = eye * kx(ii) * ux(ii,jj,kk) 
        t23(ii,jj,kk) = eye * ky(jj) * ux(ii,jj,kk) 
        t33(ii,jj,kk) = eye * kz(kk) * ux(ii,jj,kk)

        r11(ii,jj,kk) = eye * kx(ii) * uy(ii,jj,kk)
        r12(ii,jj,kk) = eye * ky(jj) * uy(ii,jj,kk)
        r13(ii,jj,kk) = eye * kz(kk) * uy(ii,jj,kk)

        r22(ii,jj,kk) = eye * kx(ii) * uz(ii,jj,kk)
        r23(ii,jj,kk) = eye * ky(jj) * uz(ii,jj,kk)
      ...
      t11 = cmplx(  &
            real(t22) * real(t22) + real(t23) * real(t23) + real(t33) * &
            real(t33), &
            aimag(t22) * aimag(t22) + aimag(t23) * aimag(t23) + aimag(t33) * &
            aimag(t33) &
            )
      t12 = cmplx( & 
            real(t22) * real(r11) + real(t23) * real(r12) + real(t33) * &
            real(r13), &
            aimag(t22) * aimag(r11) + aimag(t23) * aimag(r12) + aimag(t33) * &
            aimag(r13) &
            )
      t13 = cmplx( &
            real(t22) * real(r22) + real(t23) * real(r23) + real(t33) * &
            real(r33), &
            aimag(t22) * aimag(r22) + aimag(t23) * aimag(r23) + aimag(t33) * &
            aimag(r33) &
            )
      t22 = cmplx( &
            real(r11) * real(r11) + real(r12) * real(r12) + real(r13) * &
            real(r13), &
            aimag(r11) * aimag(r11) + aimag(r12) * aimag(r12) + aimag(r13) * &
            aimag(r13) &
            )
      t23 = cmplx( & 
            real(r11) * real(r22) + real(r12) * real(r23) + real(r13) * &
            real(r33), &
            aimag(r11) * aimag(r22) + aimag(r12) * aimag(r23) + aimag(r13) * &
            aimag(r33) &
            )
      t33 = cmplx( & 
            real(r22) * real(r22) + real(r23) * real(r23) + real(r33) * &
            real(r33), &
            aimag(r22) * aimag(r22) + aimag(r23) * aimag(r23) + aimag(r33) * &
            aimag(r33) &
            )
  ...
  deallocate(ux,uy,uz,r11,r12,r13,r22,r23,r33)
