program qrcndrij
  ...
  complex(sp), allocatable, dimension(:,:,:) :: g11,g12,g13,g22,g23,g33
  ...
  real(dp), dimension(npnt, npnt) :: pqr, cndpih
  ...
  if (ll .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./pih-cnd-qr-rij.x nx filelist ndel'
  ...
  allocate( g11(lx1,ly,lz), g12(lx1,ly,lz), g13(lx1,ly,lz), g22(lx1,ly,lz) )
  allocate( g23(lx1,ly,lz), g33(lx1,ly,lz) )
  ...
  do while ( .not. eof(20) )
    ...
    call rsgstauij(g12,g12,t11,g,nx,ny,nz)
    call rsgstauij(g12,g13,t12,g,nx,ny,nz)
    call rsgstauij(g12,g23,t13,g,nx,ny,nz)
    call rsgstauij(g13,g13,t22,g,nx,ny,nz)
    call rsgstauij(g13,g23,t23,g,nx,ny,nz)
    call rsgstauij(g23,g23,t33,g,nx,ny,nz)
    ...
    do ii = 1, lx1
      ...
      ! vorticity 
      g11(ii,jj,kk) = eye * ( ky(jj) * g23(ii,jj,kk) - kz(kk) * g13(ii,jj,kk) )
      g22(ii,jj,kk) = eye * ( kz(kk) * g12(ii,jj,kk) - kx(ii) * g23(ii,jj,kk) )
      g33(ii,jj,kk) = eye * ( kx(ii) * g13(ii,jj,kk) - ky(jj) * g12(ii,jj,kk) )

      ! rij
      g12(ii,jj,kk) = .5 * eye * (ky(jj) * g11(ii,jj,kk) + kx(ii) * g22(ii,jj,kk) )
      g13(ii,jj,kk) = .5 * eye * (kz(kk) * g11(ii,jj,kk) + kx(ii) * g33(ii,jj,kk) )
      g23(ii,jj,kk) = .5 * eye * (kz(kk) * g22(ii,jj,kk) + ky(jj) * g33(ii,jj,kk) )
  ...
  open(15,file='cndpih-rij-rq'//str(1:len_trim(str)))
  ...
  deallocate(kx,ky,kz,g,g11,g12,g13,g22,g23,g33)
  deallocate(t11,t12,t13,t22,t23,t33)

  call destroyplan3d

  write(*,*) 'Finished'
end program qrcndrij
