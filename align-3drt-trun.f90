program align3drt
  ...
  if (ll .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./align-3drt-trun.x nx filelist ndel'
  ...
  str='-'//str(1:len_trim(str))//'dx-rt-trun-'//fnm(1:len_trim(fnm))//'.dat'
  ...
  open(20,file=fnm(1:len_trim(fnm)))
    ...
    do while ( .not. eof(20)) 
      ...
      ! coarse-grain
      call unpadd ( dnsux, r12, lx1, ly, lz, dnslx1, dnsly, dnslz )
      call unpadd ( dnsuy, r13, lx1, ly, lz, dnslx1, dnsly, dnslz )
      call unpadd ( dnsuz, r23, lx1, ly, lz, dnslx1, dnsly, dnslz )
  ...
  deallocate(g,dnsux,dnsuy,dnsuz,kx,ky,kz)
