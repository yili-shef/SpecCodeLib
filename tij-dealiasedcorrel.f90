program dealiasedcorrelation
  ...
  write(*,*)
  write(*,'('' >>> dealiased correlation coefficients of the sgs stress componenets for several model <<< '')')
  write(*,*) 
  ll = iarg()
  if (ll .ne. 5) then
          write(*,*)
          ...
          write(*,*) 
          write(*,*) ' Usage: ./tij-dealiasedcorrel.x nx filelist ndellist filtertype modeltype'
          write(*,*) '        nx: resolution'
  ...
  open(28, file = 'mean-tij'//str( 1:len_trim(str) ) )
  open(29, file = 'var-tij'//str( 1:len_trim(str) ) )
  open(32, file = 'dealiased-correl-tij'//str( 1:len_trim(str) ) )
  open(33, file = 'dealiased-rho-tij'//str( 1:len_trim(str) ) )
...
end program dealiasedcorrelation 
