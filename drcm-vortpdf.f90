program rcmvortpdf
  ...
  real(dp), dimension(three,three) :: aij

  integer, parameter :: npdf = 60 
  real(dp), parameter :: bnd = 15., binw = 2.*bnd/npdf
  ...
  if (ll .ne. 5) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./rcm-vortpdf.x nfiles nstart ro nreal ifirst'
  ...
  str = 'pdfcmvort-ro='//strro(1:len_trim(strro))//'-'//strreal(1:len_trim(strreal))//'reals.dat'
