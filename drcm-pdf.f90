program rcmpdf
  ...
  if (ll .ne. 5) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./rcm-pdf.x nfiles nstart ro nreal ifirst'
  ...
  str = 'pdfcmaii-ro='//strro(1:len_trim(strro))//'-'//strreal(1:len_trim(strreal))//'reals.dat'
  open(20, file = str(1:len_trim(str)) )

  str = 'pdfcmaij-ro='//strro(1:len_trim(strro))//'-'//strreal(1:len_trim(strreal))//'reals.dat'
