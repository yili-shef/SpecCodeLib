subroutine convec(vx,vy,vz,wx,wy,wz,vxt,vyt,vzt,lx1,ly,lz,nx,ny,nz)
! on return, wx, wy, wz store the lamb vector.
  use mconstant
  use mfftwplan3d
  implicit none
  ...
  complex(sp),dimension(lx1,ly,lz),intent(inout) :: vxt,vyt,vzt ! use as temporary storage.
