program qrrij
  ...
  real(sp) :: delta_c, ignore_me, rmsrr0, mdissrate0, heli, kcut2
  ...
  if (ll .ne. 5) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./qr-rij-gcut-cndp.x nx dnsfilelist ndel disslist nthresh'
  ...
  str='-gcut-'//str(1:len_trim(str))//'dx-cndp'//disslist(1:len_trim(disslist))//'-'//fnm(1:len_trim(fnm))//'.dat'
  ...
  deallocate(kx,ky,kz,g,r11,r12,r13,r22,r23,r33, helidiss, gcut)
