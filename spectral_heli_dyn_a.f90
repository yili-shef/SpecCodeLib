PROGRAM spectral
  ...
  LOGICAL  :: new, update
  ! Parameters should be input from 'parameter_heli_dyn_a.d' initially.
  ...
  OPEN(90,file='parameter_heli_dyn_a.d',status='unknown')
    READ(90,*) forcetype
    READ(90,*) nx
    READ(90,*) ny
    READ(90,*) nz
...
!============== Begin the loop ====================================
  ...
  WRITE(26,*) '# jstep,time,LM,LP,MM,PP,PM'
...
! WRITE out the total energy in K space
  ...
  IF (MOD(jstep,ieout).EQ.0) THEN
    ...
    WRITE(26,'(I8,6E12.4)')jstep,time,LM,LP,MM,PP,PM
  END IF
