program rcmpdf
  ...
  real(dp) :: meanaiiperp, meanaiipara, rmsaiiperp, rmsaiipara, meanaiiall, rmsaiiall
  ...
  do while ( .not. eof(22))
    ...
    read(15, '(15E13.4)') meanaiiall, meanaiiperp, meanaiipara, meana12, meana13, meana21, &
                          meana23, meana31, meana32 
 
    read(16, '(15E13.4)') rmsaiiall, rmsaiiperp, rmsaiipara, rmsa12, rmsa13, rmsa21, &
