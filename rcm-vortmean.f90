program rcmvortmean
  ...
  if (ll .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./rcm-vortmean.x filelist nreal ifirst'
  ...
  str = 'vortmean-'//strro(1:len_trim(strro))//'-'//strreal(1:len_trim(strreal))//'reals.dat'
  open(15, file = str(1:len_trim(str)) )
  write(15, *)'meanwx, meanwy, meanwz'

  str = 'vortrms-'//strro(1:len_trim(strro))//'-'//strreal(1:len_trim(strreal))//'reals.dat'
  open(16, file = str(1:len_trim(str)) )
  write(16, *)'rmswx, rmswy, rmswz'

  str = 'vortskew-'//strro(1:len_trim(strro))//'-'//strreal(1:len_trim(strreal))//'reals.dat'
  open(17, file = str(1:len_trim(str)) )
  write(17, *)'skewwx, skewwy, skewez'

  str = 'vortflat-'//strro(1:len_trim(strro))//'-'//strreal(1:len_trim(strreal))//'reals.dat'
