program qrrij
  ...
  real(dp) :: const
  real :: delta_c, ignore_me, rmsrr, rmsrr0, kcut2
  ...
  if (ll .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./qr-rij-gcut.x nx filelist ndel'
  ...
  open(15,file='jp-rij-gcut-rq'//str(1:len_trim(str)))
  ...
  deallocate(kx,ky,kz,g,gcut,r11,r12,r13,r22,r23,r33)
