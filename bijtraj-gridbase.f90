program bijongrid
    ...
    if ( iargc() .ne. 6) stop 'Usage: ./bijtraj-gridbase.x nx dt 1stfile-no lastfile-no pref-for-xyz initfile'
    ...
    if ( info .eq. .false. ) then
      ...
      write(*,*) '!!!!!!!!!!!!! WARNING: no initial field !!!!!!!!!!!!!!!'
    ...
    write(*,*) 'bijtraj-gridbase.x: reading data file: ', str(1:len_trim(str))
    ...
    write(*,*) 'bijtraj-gridbase.x: Finished.'
    stop
