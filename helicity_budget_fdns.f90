! The subroutine is used to calculate the helicity budget from a filtered DNS
! velocity field. The difference between this and the subroutine
! helicity_budget_les is that here subroutine convec_dns, other than convec, is
...
SUBROUTINE helicity_budget_fdns(ux,uy,uz,tau11,tau12,tau13,tau22,tau23,tau33,kx,ky,kz,k2,nu,THk,PiHk,Hk,DHk,SGSDHk, &
                           lx1,ly,lz,nx,ny,nz)
  USE mconstant
  IMPLICIT NONE
...
END SUBROUTINE helicity_budget_fdns
