program coraijpij
  ...
  if (iargc() .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./cor-aijpij.x nx fnamelist ndel'
  ...
  do while ( .not. eof(33) )
    ...
    caijpij = caijpij + sum( real(s11(1:lx,:,:)) * real(p11(1:lx,:,:)) &
    ...
    caijpij = caijpij + sum( aimag(s11(1:lx,:,:)) * aimag(p11(1:lx,:,:)) &
  ...
  caijpij = caijpij * ignore_me

  write(*,*) 'correlation betweein aij and pij (<aijpij>):', caijpij
