...
!  real(sp), parameter :: mdissrate0 = 0.2651 ! Delta = 16 dx
!  real(sp), parameter :: mdissrate0 = 0.2375 ! Delta =  8 dx
  ...
  if (ll .ne. 4) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./sgshd-decmp-cnd-align-1d.x nx filelist ndel normdissrate'
  ...
  open(15,file='cndsgshd-decmp'//str(1:len_trim(str)))
