program ptqraij
  ...
  real(sp),    allocatable, dimension(:)     :: kx, ky, kz, q, r
  ...
  do while ( .not. eof(30) )
    ...
    do ip=1, nprtcle
      ...
      ! for testing purpose: scatter plot
      q(ip) = qaijp; r(ip) = raijp
