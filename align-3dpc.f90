program align3dpc
  ...
  if (iargc() .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./align-3dpc.x nx file# prefix'
  ...
  open(15, file = 'align1dpdf-pp3cc2-3dpc-'//prf(1:len_trim(prf))//flnm(1:len_trim(flnm))//'.dat')
    do ii=1,npnt
      write(15,'(15E15.5)') (ii-.5) * bwcth, p1dpp3cc2(ii)
    end do
  close(15)

  open(15, file = 'align2dpdf-pp3incc-3dpc-'//prf(1:len_trim(prf))//flnm(1:len_trim(flnm))//'.dat')
    do ii=1,npnt
    do jj=1,npnt
  ...
  open(15, file = 'align3dpdf-3dpc-'//prf(1:len_trim(prf))//flnm(1:len_trim(flnm))//'.dat')
  ...
  write(*,*) 'align-3dpc.x done.'

end program align3dpc
