...
!....... definitions in fftw3.f ......................................
  ...
  omega = urms0 / (2 * l) / ro
  write(  *,*) 'omega = ', omega, 'urms0 = ', urms0, 'l =', l
  write(911,*) 'omega = ', omega, 'urms0 = ', urms0, 'l =', l
...
!  close(unit=21)
  ...
  call apply_MTLM(vx08,vy08,vz08,nt/32 + 2,                         &
                  IFTvx08,IFTvy08,IFTvz08,FTvx08,FTvy08,FTvz08)

  call apply_MTLM(vx16,vy16,vz16,nt/16 + 2,                         &
                  IFTvx16,IFTvy16,IFTvz16,FTvx16,FTvy16,FTvz16)

  call apply_MTLM(vx32,vy32,vz32,nt/8 + 2,                          &
                  IFTvx32,IFTvy32,IFTvz32,FTvx32,FTvy32,FTvz32)

  call apply_MTLM(vx64,vy64,vz64,nt/4 + 2,                          &
                  IFTvx64,IFTvy64,IFTvz64,FTvx64,FTvy64,FTvz64)
 
  call apply_MTLM(vx128,vy128,vz128,nt/2 + 2,IFTvx128,IFTvy128,    &
