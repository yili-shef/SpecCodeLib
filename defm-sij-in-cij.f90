program defmsijincij
  ...
  real(dp) :: saa, sbb, sgg, sab, sag, sbg
  real(dp) :: saa1, saa2, saa3, sbb1, sbb2, sbb3, sgg1, sgg2, sgg3
  real(dp) :: sab1, sab2, sab3, sbg1, sbg2, sbg3, sag1, sag2, sag3

  real(dp) :: msaa,  msbb,  msgg,  msab,  msag,  msbg
  real(dp) :: msaa1, msaa2, msaa3, msbb1, msbb2, msbb3, msgg1, msgg2, msgg3
  real(dp) :: msab1, msab2, msab3, msbg1, msbg2, msbg3, msag1, msag2, msag3

  real(dp) :: vsaa,  vsbb,  vsgg,  vsab,  vsag,  vsbg
  real(dp) :: vsaa1, vsaa2, vsaa3, vsbb1, vsbb2, vsbb3, vsgg1, vsgg2, vsgg3
  real(dp) :: vsab1, vsab2, vsab3, vsbg1, vsbg2, vsbg3, vsag1, vsag2, vsag3
  ...
  if (iargc() .ne. 3) then
          ...
          write(*,*) 
          write(*,*) ' Usage: ./defm-sij-in-cij.x nx filelist prefix'
